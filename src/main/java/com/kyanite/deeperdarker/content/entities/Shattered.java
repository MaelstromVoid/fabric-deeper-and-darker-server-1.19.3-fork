...
public class Shattered extends Monster implements DisturbanceListener, VibrationListener.VibrationListenerConfig {
    ...
    @Override
    public void onSignalReceive(ServerLevel pLevel, GameEventListener pGameEventListener, BlockPos pPos, GameEvent pGameEvent, Entity pEntity, Entity pPlayerEntity, float pDistance) {
