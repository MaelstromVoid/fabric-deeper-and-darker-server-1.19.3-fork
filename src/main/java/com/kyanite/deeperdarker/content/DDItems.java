...
public class DDItems {
    ...
    public static final Item SOUL_ELYTRA = register("soul_elytra", new SoulElytraItem(new FabricItemSettings().equipmentSlot((slot) -> EquipmentSlot.CHEST).durability(956).rarity(Rarity.UNCOMMON)));
    ...
    public static final Item WARDEN_HOE = register("warden_hoe", new DDHoeItem(DDTiers.WARDEN, -4, 0, new Item.Properties().rarity(Rarity.RARE).fireResistant()));
    ...
    public static final Item WARDEN_HELMET = register("warden_helmet", new WardenArmorItem(DDArmorMaterials.WARDEN, EquipmentSlot.HEAD, new Item.Properties().rarity(Rarity.RARE).fireResistant()));
    public static final Item WARDEN_CHESTPLATE = register("warden_chestplate", new WardenArmorItem(DDArmorMaterials.WARDEN, EquipmentSlot.CHEST, new Item.Properties().rarity(Rarity.RARE).fireResistant()));
    public static final Item WARDEN_LEGGINGS = register("warden_leggings", new WardenArmorItem(DDArmorMaterials.WARDEN, EquipmentSlot.LEGS, new Item.Properties().rarity(Rarity.RARE).fireResistant()));
    public static final Item WARDEN_BOOTS = register("warden_boots", new WardenArmorItem(DDArmorMaterials.WARDEN, EquipmentSlot.FEET, new Item.Properties().rarity(Rarity.RARE).fireResistant()));
