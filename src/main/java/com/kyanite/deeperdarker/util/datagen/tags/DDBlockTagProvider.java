...
public class DDBlockTagProvider extends FabricTagProvider.BlockTagProvider
{
    ...
    {
        getOrCreateTagBuilder(BlockTags.MINEABLE_WITH_AXE).addTag(DDTags.Blocks.ECHO_LOGS)
                                                          .add(
        ...
        getOrCreateTagBuilder(BlockTags.COAL_ORES).add(
                DDBlocks.SCULK_STONE_COAL_ORE,
                DDBlocks.GLOOMSLATE_COAL_ORE
        );
        ...
        getOrCreateTagBuilder(BlockTags.COPPER_ORES).add(
                DDBlocks.SCULK_STONE_COPPER_ORE,
                DDBlocks.GLOOMSLATE_COPPER_ORE
        );
        getOrCreateTagBuilder(BlockTags.GOLD_ORES).add(
                DDBlocks.SCULK_STONE_GOLD_ORE,
                DDBlocks.GLOOMSLATE_GOLD_ORE
        );
        getOrCreateTagBuilder(BlockTags.REDSTONE_ORES).add(
                DDBlocks.SCULK_STONE_REDSTONE_ORE,
                DDBlocks.GLOOMSLATE_REDSTONE_ORE
        );
        getOrCreateTagBuilder(BlockTags.EMERALD_ORES).add(
                DDBlocks.SCULK_STONE_EMERALD_ORE,
                DDBlocks.GLOOMSLATE_EMERALD_ORE
        );
        getOrCreateTagBuilder(BlockTags.LAPIS_ORES).add(
                DDBlocks.SCULK_STONE_LAPIS_ORE,
                DDBlocks.GLOOMSLATE_LAPIS_ORE
        );
        getOrCreateTagBuilder(BlockTags.DIAMOND_ORES).add(
                DDBlocks.SCULK_STONE_DIAMOND_ORE,
                DDBlocks.GLOOMSLATE_DIAMOND_ORE
        );
        ...
        getOrCreateTagBuilder(DDTags.Blocks.ECHO_LOGS).add(
                DDBlocks.ECHO_LOG,
                DDBlocks.ECHO_WOOD,
                DDBlocks.STRIPPED_ECHO_LOG,
                DDBlocks.STRIPPED_ECHO_WOOD
        );
        getOrCreateTagBuilder(DDTags.Blocks.ECHO_SOIL).add(
                DDBlocks.ECHO_SOIL,
                Blocks.SCULK
        );
        getOrCreateTagBuilder(DDTags.Blocks.SCULK_STONE_REPLACEABLES).add(
                DDBlocks.SCULK_STONE,
                DDBlocks.SCULK_GRIME
        );
        getOrCreateTagBuilder(DDTags.Blocks.SCULK_REPLACEABLES).add(
                Blocks.SCULK,
                DDBlocks.SCULK_GRIME
        );
        getOrCreateTagBuilder(DDTags.Blocks.GLOOMSLATE_REPLACEABLE).add(
                DDBlocks.GLOOMY_SCULK,
                DDBlocks.GLOOMY_GEYSER
        );
        getOrCreateTagBuilder(DDTags.Blocks.GLOOMY_SCULK_REPLACEABLE).add(
                Blocks.SCULK,
                DDBlocks.SCULK_STONE,
                DDBlocks.GLOOMSLATE,
                DDBlocks.SCULK_GRIME,
        ...
        getOrCreateTagBuilder(DDTags.Blocks.TRANSMITTABLE).forceAddTag(BlockTags.SHULKER_BOXES)
        ...
        getOrCreateTagBuilder(DDTags.Blocks.INFINIBURN_OTHERSIDE).forceAddTag(BlockTags.INFINIBURN_NETHER)
                                                                 .add(DDBlocks.GLOOMSLATE);
    }
}