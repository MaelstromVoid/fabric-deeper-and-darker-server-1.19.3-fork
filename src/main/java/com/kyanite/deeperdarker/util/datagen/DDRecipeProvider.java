...
public class DDRecipeProvider extends FabricRecipeProvider
{
    ...
    public void buildRecipes(Consumer<FinishedRecipe> exporter)
    {
        ...
        NETHERITE_HELMET_TO_WARDEN_HELMET_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_CHESTPLATE_TO_WARDEN_CHESTPLATE_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_LEGGINGS_TO_WARDEN_LEGGINGS_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_BOOTS_TO_WARDEN_BOOTS_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_SWORD_TO_WARDEN_SWORD_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_SHOVEL_TO_WARDEN_SHOVEL_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_PICKAXE_TO_WARDEN_PICKAXE_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_AXE_TO_WARDEN_AXE_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_HOE_TO_WARDEN_HOE_UPGRADE.unlocks(
                FabricRecipeProvider.getHasName(
                        DDItems.REINFORCED_ECHO_SHARD),
                FabricRecipeProvider.has(
                        DDItems.REINFORCED_ECHO_SHARD)
        );
        NETHERITE_HELMET_TO_WARDEN_HELMET_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_helmet_to_warden_helmet_upgrade"
                )
        );
        NETHERITE_CHESTPLATE_TO_WARDEN_CHESTPLATE_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_chestplate_to_warden_chestplate_upgrade"
                )
        );
        NETHERITE_LEGGINGS_TO_WARDEN_LEGGINGS_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_leggings_to_warden_leggings_upgrade"
                )
        );
        NETHERITE_BOOTS_TO_WARDEN_BOOTS_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_boots_to_warden_boots_upgrade"
                )
        );
        NETHERITE_SWORD_TO_WARDEN_SWORD_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_sword_to_warden_sword_upgrade"
                )
        );
        NETHERITE_PICKAXE_TO_WARDEN_PICKAXE_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_pickaxe_to_warden_pickaxe_upgrade"
                )
        );
        NETHERITE_AXE_TO_WARDEN_AXE_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_axe_to_warden_axe_upgrade"
                )
        );
        NETHERITE_SHOVEL_TO_WARDEN_SHOVEL_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_shovel_to_warden_shovel_upgrade"
                )
        );
        NETHERITE_HOE_TO_WARDEN_HOE_UPGRADE.save(
                exporter, new ResourceLocation(
                        DeeperDarker.MOD_ID,
                        "netherite_hoe_to_warden_hoe_upgrade"
                )
        );

        // Wood stuff
        planksFromLogs(
                exporter, DDBlocks.ECHO_PLANKS,
                TagKey.create(
                        Registries.ITEM,
        ...
        oneToOneConversionRecipe(
                exporter, DDBlocks.ECHO_BUTTON,
                DDBlocks.ECHO_PLANKS,
                "wooden_button"
        );
        doorBuilder(
                DDBlocks.ECHO_DOOR, Ingredient.of(
                        DDBlocks.ECHO_PLANKS)
        ).unlockedBy(
                FabricRecipeProvider.getHasName(
                        DDBlocks.ECHO_PLANKS),
        ...
        signBuilder(
                DDBlocks.ECHO_SIGN, Ingredient.of(
                        DDBlocks.ECHO_PLANKS)
        ).unlockedBy(
                FabricRecipeProvider.getHasName(
                        DDBlocks.ECHO_PLANKS),
        ...
        woodenBoat(
                exporter, DDItems.ECHO_BOAT,
                DDBlocks.ECHO_PLANKS
        );
        chestBoat(
                exporter, DDItems.ECHO_CHEST_BOAT,
                DDBlocks.ECHO_PLANKS
        );
        ...
        stonecutterResultFromBase(
                ...
                RecipeCategory.BUILDING_BLOCKS,
                DDBlocks.COBBLED_SCULK_STONE_SLAB,
                DDBlocks.COBBLED_SCULK_STONE, 2
        );
        wall(
                exporter,
                RecipeCategory.BUILDING_BLOCKS,
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE),
                RecipeCategory.BUILDING_BLOCKS,
                DDBlocks.SMOOTH_SCULK_STONE, 0.1f,
                200, "sculk_stone"
        );
        stairBuilder(
        ...
        stairBuilder(
                ...
                Ingredient.of(DDBlocks.GLOOMSLATE)
        );
        stonecutterResultFromBase(
                exporter,
                RecipeCategory.BUILDING_BLOCKS,
        ...
        stairBuilder(
                ...
                getHasName(
                        DDBlocks.COBBLED_GLOOMSLATE),
                has(DDBlocks.COBBLED_GLOOMSLATE)
        ).save(exporter);
        stonecutterResultFromBase(
                exporter,
                RecipeCategory.BUILDING_BLOCKS,
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE),
                RecipeCategory.BUILDING_BLOCKS,
                DDBlocks.SMOOTH_GLOOMSLATE, 0.1f,
                200, "sculk_stone"
        );
        stairBuilder(
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_COAL_ORE),
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_IRON_ORE),
                RecipeCategory.MISC,
        ...
        oreBlasting(
                ...
                List.of(DDBlocks.SCULK_STONE_IRON_ORE),
                RecipeCategory.MISC,
                Items.IRON_INGOT, 0.7f, 100,
                "iron_ingot"
        );
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_COPPER_ORE),
                RecipeCategory.MISC,
                Items.COPPER_INGOT, 0.7f, 200,
                "copper_ingot"
        );
        oreBlasting(
                exporter,
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_GOLD_ORE),
                RecipeCategory.MISC,
                Items.GOLD_INGOT, 1.0f, 200,
                "gold_ingot"
        );
        oreBlasting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_GOLD_ORE),
                RecipeCategory.MISC,
                Items.GOLD_INGOT, 1.0f, 100,
                "gold_ingot"
        );
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_REDSTONE_ORE),
                RecipeCategory.MISC,
                Items.REDSTONE, 0.7f, 200,
                "redstone"
        );
        oreBlasting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_REDSTONE_ORE),
                RecipeCategory.MISC,
                Items.REDSTONE, 0.7f, 100,
                "redstone"
        );
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_EMERALD_ORE),
                RecipeCategory.MISC,
                Items.EMERALD, 1.0f, 200,
                "emerald"
        );
        oreBlasting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_EMERALD_ORE),
                RecipeCategory.MISC,
                Items.EMERALD, 1.0f, 100,
                "emerald"
        );
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_LAPIS_ORE),
                RecipeCategory.MISC,
                Items.LAPIS_LAZULI, 0.2f, 200,
                "lapis_lazuli"
        );
        oreBlasting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_LAPIS_ORE),
                RecipeCategory.MISC,
                Items.LAPIS_LAZULI, 0.2f, 100,
                "lapis_lazuli"
        );
        oreSmelting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_DIAMOND_ORE),
                RecipeCategory.MISC,
                Items.DIAMOND, 1.0f, 200,
                "diamond"
        );
        oreBlasting(
                exporter,
                List.of(DDBlocks.SCULK_STONE_DIAMOND_ORE),
                RecipeCategory.MISC,
                Items.DIAMOND, 1.0f, 100,
                "diamond"
        );
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_COAL_ORE),
                RecipeCategory.MISC, Items.COAL,
                0.1f, 200, "coal"
        );
        oreBlasting(
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_IRON_ORE),
                RecipeCategory.MISC,
                Items.IRON_INGOT, 0.7f, 200,
                "iron_ingot"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_COPPER_ORE),
                RecipeCategory.MISC,
                Items.COPPER_INGOT, 0.7f, 200,
                "copper_ingot"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_GOLD_ORE),
                RecipeCategory.MISC,
                Items.GOLD_INGOT, 1.0f, 200,
                "gold_ingot"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_REDSTONE_ORE),
                RecipeCategory.MISC,
                Items.REDSTONE, 0.7f, 200,
                "redstone"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_EMERALD_ORE),
                RecipeCategory.MISC,
                Items.EMERALD, 1.0f, 200,
                "emerald"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_LAPIS_ORE),
                RecipeCategory.MISC,
                Items.LAPIS_LAZULI, 0.2f, 200,
                "lapis_lazuli"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMSLATE_DIAMOND_ORE),
                RecipeCategory.MISC,
                Items.DIAMOND, 1.0f, 200,
                "diamond"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDItems.GRIME_BALL),
                RecipeCategory.MISC,
                DDItems.GRIME_BRICK, 0.3f, 200,
                "grime_brick"
        );
        ...
        oreSmelting(
                exporter,
                List.of(DDBlocks.GLOOMY_CACTUS),
                RecipeCategory.MISC,
                DDBlocks.GLOOMY_CACTUS, 1.0f, 200,
                "orange_dye"
        );
    }
