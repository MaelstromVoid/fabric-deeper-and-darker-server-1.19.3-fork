...
public class DDModelProvider extends FabricModelProvider
{
    ...
    public void generateBlockStateModels(BlockModelGenerators blockModelGenerators)
    {
        ...
        blockModelGenerators.woodProvider(DDBlocks.STRIPPED_ECHO_LOG)
                            .log(DDBlocks.STRIPPED_ECHO_LOG)
                            .wood(DDBlocks.STRIPPED_ECHO_WOOD);
        ...
        blockModelGenerators.createCrossBlockWithDefaultItem(
                DDBlocks.ECHO_SAPLING, net.minecraft.data.models.BlockModelGenerators.TintState.NOT_TINTED);
        blockModelGenerators.blockEntityModels(DDBlocks.ECHO_SIGN, DDBlocks.ECHO_PLANKS)
                            .create(DDBlocks.ECHO_SIGN, DDBlocks.ECHO_WALL_SIGN);
        ...
        blockModelGenerators.createCrossBlock(
                DDBlocks.SCULK_TENDRILS_PLANT, net.minecraft.data.models.BlockModelGenerators.TintState.NOT_TINTED);
        blockModelGenerators.createCrossBlock(
                DDBlocks.SCULK_TENDRILS, net.minecraft.data.models.BlockModelGenerators.TintState.NOT_TINTED);
        blockModelGenerators.createCrossBlock(
                DDBlocks.SCULK_VINES_PLANT, net.minecraft.data.models.BlockModelGenerators.TintState.NOT_TINTED);
        blockModelGenerators.createCrossBlock(
                DDBlocks.SCULK_VINES, net.minecraft.data.models.BlockModelGenerators.TintState.NOT_TINTED);

        blockModelGenerators.createNonTemplateModelBlock(DDBlocks.GLOOMY_CACTUS);
        blockModelGenerators.delegateItemModel(
                DDBlocks.GLOOMY_CACTUS, ModelLocationUtils.getModelLocation(DDBlocks.GLOOMY_CACTUS));
        blockModelGenerators.createCrossBlockWithDefaultItem(
                DDBlocks.GLOOMY_GRASS, net.minecraft.data.models.BlockModelGenerators.TintState.NOT_TINTED);
        ...
        ModelTemplates.CUBE_BOTTOM_TOP.create(
                ...
                TextureMapping.singleSlot(TextureSlot.TOP, new ResourceLocation(DeeperDarker.MOD_ID, "block/gloomy_geyser"))
                              .put(
                                      TextureSlot.SIDE, TexturedModel.CUBE.get(DDBlocks.GLOOMY_SCULK)
                                                                          .getMapping()
                                                                          .get(TextureSlot.ALL)
                              )
                              .put(
                                      TextureSlot.BOTTOM, TexturedModel.CUBE.get(DDBlocks.GLOOMY_SCULK)
                                                                            .getMapping()
                                                                            .get(TextureSlot.ALL)
        ...
        blockModelGenerators.delegateItemModel(
                DDBlocks.ANCIENT_VASE, ModelLocationUtils.getModelLocation(DDBlocks.ANCIENT_VASE));

        blockModelGenerators.createNonTemplateModelBlock(DDBlocks.CRYSTALLIZED_AMBER);
        registerParented(
                blockModelGenerators, Blocks.HONEY_BLOCK, DDBlocks.CRYSTALLIZED_AMBER,
                ...
                new Tuple<>(
                        ...
                        ModelLocationUtils.getModelLocation(DDBlocks.CRYSTALLIZED_AMBER, "_inner")
                ), new Tuple<>(TextureSlot.DOWN, ModelLocationUtils.getModelLocation(DDBlocks.CRYSTALLIZED_AMBER, "_outer"))
        );

        blockModelGenerators.delegateItemModel(
                DDBlocks.CRYSTALLIZED_AMBER, ModelLocationUtils.getModelLocation(DDBlocks.CRYSTALLIZED_AMBER));

        blockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.multiVariant(DDBlocks.OTHERSIDE_PORTAL)
                                                                          .with(PropertyDispatch.property(
                                                                                  BlockStateProperties.AXIS).select(
                                                                                  Direction.Axis.X, Variant.variant().with(
                                                                                  ...
                                                                                  Direction.Axis.Y, Variant.variant().with(
                                                                                          VariantProperties.MODEL,
                                                                                          ModelLocationUtils.getModelLocation(
                                                                                                  DDBlocks.OTHERSIDE_PORTAL,
                                                                                                  "_ns"
                                                                                  ...
                                                                                  Direction.Axis.Z, Variant.variant().with(
                                                                                          VariantProperties.MODEL,
                                                                                          ModelLocationUtils.getModelLocation(
                                                                                                  DDBlocks.OTHERSIDE_PORTAL,
                                                                                                  "_ew"
        ...
        registerParented(
                blockModelGenerators, ModelLocationUtils.getModelLocation(Blocks.NETHER_PORTAL, "_ew"),
                ModelLocationUtils.getModelLocation(DDBlocks.OTHERSIDE_PORTAL, "_ew"),
        ...
        registerParented(
                blockModelGenerators, ModelLocationUtils.getModelLocation(Blocks.NETHER_PORTAL, "_ns"),
                ModelLocationUtils.getModelLocation(DDBlocks.OTHERSIDE_PORTAL, "_ns"),
                new Tuple<>(TextureSlot.PARTICLE, TextureMapping.getBlockTexture(DDBlocks.OTHERSIDE_PORTAL)),
                new Tuple<>(TextureSlot.create("portal"), TextureMapping.getBlockTexture(DDBlocks.OTHERSIDE_PORTAL))
        );
        ...
        ModelTemplates.FLOWER_POT_CROSS.create(
                DDBlocks.POTTED_ECHO_SAPLING, TextureMapping.plant(DDBlocks.ECHO_SAPLING), blockModelGenerators.modelOutput);
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator)
    {
        ...
        ModelTemplates.FLAT_ITEM.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SCULK_TENDRILS.asItem()),
                TextureMapping.layer0(DDBlocks.SCULK_TENDRILS_PLANT), itemModelGenerator.output
        );
        ModelTemplates.FLAT_ITEM.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SCULK_VINES.asItem()),
                TextureMapping.layer0(DDBlocks.SCULK_VINES_PLANT), itemModelGenerator.output
        );
        ModelTemplates.BUTTON_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.ECHO_BUTTON.asItem()),
                TextureMapping.cube(DDBlocks.ECHO_PLANKS), itemModelGenerator.output
        );
        ModelTemplates.FENCE_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.ECHO_FENCE.asItem()), TextureMapping.cube(DDBlocks.ECHO_PLANKS),
                itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SCULK_STONE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.SCULK_STONE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.COBBLED_SCULK_STONE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.COBBLED_SCULK_STONE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.POLISHED_SCULK_STONE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.POLISHED_SCULK_STONE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SCULK_STONE_BRICK_WALL.asItem()),
                TextureMapping.cube(DDBlocks.SCULK_STONE_BRICKS), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SCULK_STONE_TILE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.SCULK_STONE_TILES), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SMOOTH_SCULK_STONE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.SMOOTH_SCULK_STONE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.CUT_SCULK_STONE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.CUT_SCULK_STONE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SCULK_GRIME_BRICK_WALL.asItem()),
                TextureMapping.cube(DDBlocks.SCULK_GRIME), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.GLOOMSLATE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.GLOOMSLATE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.COBBLED_GLOOMSLATE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.COBBLED_GLOOMSLATE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.POLISHED_GLOOMSLATE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.POLISHED_GLOOMSLATE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.GLOOMSLATE_BRICK_WALL.asItem()),
                TextureMapping.cube(DDBlocks.GLOOMSLATE_BRICKS), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.GLOOMSLATE_TILE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.GLOOMSLATE_TILES), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.SMOOTH_GLOOMSLATE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.SMOOTH_GLOOMSLATE), itemModelGenerator.output
        );
        ModelTemplates.WALL_INVENTORY.create(
                ModelLocationUtils.getModelLocation(DDBlocks.CUT_GLOOMSLATE_WALL.asItem()),
                TextureMapping.cube(DDBlocks.CUT_GLOOMSLATE), itemModelGenerator.output
        );
        ...
        registerGeneratedWithPredicate(
                itemModelGenerator, DDItems.SOUL_ELYTRA, ResourceLocation.DEFAULT_NAMESPACE + ":broken", "_broken");
    ...
    {
        ResourceLocation buttonModel = ModelTemplates.BUTTON.create(
                block, TexturedModel.CUBE.get(planks).getMapping(), blockModelGenerators.modelOutput);
        ResourceLocation buttonPressedModel = ModelTemplates.BUTTON_PRESSED.create(
                block, TexturedModel.CUBE.get(planks)
                                         .getMapping(), blockModelGenerators.modelOutput
        );
    ...
    )
    {
        ...
        ResourceLocation fenceGateOpenModel = ModelTemplates.FENCE_GATE_OPEN.create(
                block, textureMap, blockModelGenerators.modelOutput);
        ResourceLocation fenceGateModel = ModelTemplates.FENCE_GATE_CLOSED.create(
                block, textureMap, blockModelGenerators.modelOutput);
        ResourceLocation wallFenceGateOpenModel = ModelTemplates.FENCE_GATE_WALL_OPEN.create(
                block, textureMap, blockModelGenerators.modelOutput);
        ResourceLocation wallFenceGateModel = ModelTemplates.FENCE_GATE_WALL_CLOSED.create(
                block, textureMap, blockModelGenerators.modelOutput);
        blockModelGenerators.blockStateOutput.accept(
                MultiVariantGenerator.multiVariant(block, Variant.variant().with(VariantProperties.UV_LOCK, true))
                                     ...
                                     .with(PropertyDispatch.properties(
                                             BlockStateProperties.IN_WALL, BlockStateProperties.OPEN).select(
                                             false, false, Variant.variant()
                                                                  .with(
                                                                          VariantProperties.MODEL, fenceGateModel)
                                     ).select(
                                             true, false, Variant.variant()
                                                                 .with(
                                                                         VariantProperties.MODEL, wallFenceGateModel)
                                     ).select(
                                             false, true, Variant.variant()
                                                                 .with(
                                                                         VariantProperties.MODEL, fenceGateOpenModel)
                                     ).select(
                                             true, true, Variant.variant()
                                                                .with(
                                                                        VariantProperties.MODEL, wallFenceGateOpenModel)
                                     )));


    }

    private static void registerFence(
            BlockModelGenerators blockModelGenerators,
            Block block,
            Block textureSource
    )
    ...
    private static void registerPressurePlate(
            BlockModelGenerators blockModelGenerators,
            Block pressurePlate,
            Block textureSource
    )
    {
        TextureMapping textureMap = TextureMapping.defaultTexture(textureSource);
        ResourceLocation upModel = ModelTemplates.PRESSURE_PLATE_UP.create(
                pressurePlate, textureMap, blockModelGenerators.modelOutput);
        ResourceLocation downModel = ModelTemplates.PRESSURE_PLATE_DOWN.create(
                pressurePlate, textureMap, blockModelGenerators.modelOutput);
        blockModelGenerators.blockStateOutput.accept(
                BlockModelGenerators.createPressurePlate(pressurePlate, upModel, downModel));
    }

    private static void registerSlabWithCubeAll(
            BlockModelGenerators blockModelGenerators,
            Block slab,
            Block textureSource
    )
    {
        ...
        ResourceLocation ResourceLocation2 = ModelTemplates.SLAB_BOTTOM.create(
                slab, texturedModel.getMapping(), blockModelGenerators.modelOutput);
        ResourceLocation ResourceLocation3 = ModelTemplates.SLAB_TOP.create(
                slab, texturedModel.getMapping(), blockModelGenerators.modelOutput);
        blockModelGenerators.blockStateOutput.accept(
                BlockModelGenerators.createSlab(slab, ResourceLocation2, ResourceLocation3, ResourceLocation));
    }
    ...
    )
    {
        ...
        ResourceLocation innerModel = ModelTemplates.STAIRS_INNER.create(
                stairs, textureMap, blockModelGenerators.modelOutput);
        ResourceLocation regularModel = ModelTemplates.STAIRS_STRAIGHT.create(
                stairs, textureMap, blockModelGenerators.modelOutput);
        ResourceLocation outerModel = ModelTemplates.STAIRS_OUTER.create(
                stairs, textureMap, blockModelGenerators.modelOutput);
        blockModelGenerators.blockStateOutput.accept(
                BlockModelGenerators.createStairs(stairs, innerModel, regularModel, outerModel));
    }
    ...
    )
    {
        ...
        ResourceLocation sideTallModel = ModelTemplates.WALL_TALL_SIDE.create(
                wall, textureMap, blockModelGenerators.modelOutput);
        blockModelGenerators.blockStateOutput.accept(
                BlockModelGenerators.createWall(wall, postModel, sideModel, sideTallModel));
    }

    private static void registerSculkJaw(
            BlockModelGenerators blockModelGenerators,
            Block sculkJaw
    )
    {
        ResourceLocation sculkJawModel = ModelTemplates.CUBE_TOP.create(
                sculkJaw, TextureMapping.singleSlot(TextureSlot.TOP, TextureMapping.getBlockTexture(sculkJaw))
                                        .put(TextureSlot.SIDE, TextureMapping.getBlockTexture(sculkJaw, "_side")),
                blockModelGenerators.modelOutput
        );
        ResourceLocation sculkJawBitingModel = ModelTemplates.CUBE_TOP.create(
                ModelLocationUtils.getModelLocation(sculkJaw, "_biting"),
                TextureMapping.singleSlot(TextureSlot.TOP, TextureMapping.getBlockTexture(sculkJaw, "_biting"))
                              .put(TextureSlot.SIDE, TextureMapping.getBlockTexture(sculkJaw, "_side")),
                blockModelGenerators.modelOutput
        );

        blockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.multiVariant(DDBlocks.SCULK_JAW)
                                                                          .with(net.minecraft.data.models.BlockModelGenerators.createBooleanModelDispatch(
                                                                                  SculkJawBlock.BITING, sculkJawBitingModel,
                                                                                  sculkJawModel
                                                                          )));
    }

    private static void registerGeneratedWithPredicate(
    ...
    {
        ResourceLocation withPredicate = ModelTemplates.FLAT_ITEM.create(
                prefixResourceLocation(suffixResourceLocation(BuiltInRegistries.ITEM.getKey(item), suffix), "item/"),
                TextureMapping.layer0(
                        prefixResourceLocation(
                                suffixResourceLocation(BuiltInRegistries.ITEM.getKey(item), suffix), "item/")),
                itemModelGenerator.output
        );
        JsonObject withoutPredicateJsonObject = createModelTemplateJson(
                ModelTemplates.FLAT_ITEM, prefixResourceLocation(BuiltInRegistries.ITEM.getKey(item), "item/"),
                new TextureMapping().put(
                        TextureSlot.LAYER0,
                        prefixResourceLocation(BuiltInRegistries.ITEM.getKey(item), "item/")
                )
        );
        ...
        override.addProperty(
                "model", prefixResourceLocation(
                        suffixResourceLocation(BuiltInRegistries.ITEM.getKey(item), suffix),
                        "item/"
                ).toString()
        );
        ...
        itemModelGenerator.output.accept(
                prefixResourceLocation(BuiltInRegistries.ITEM.getKey(item), "item/"),
                () -> withoutPredicateJsonObject
        );
    }

    private static void registerSculkTransmitter(
            ItemModelGenerators itemModelGenerator,
            SculkTransmitterItem item
    )
    {
    ...
    )
    {
        ...
        itemModelGenerator.output.accept(prefixResourceLocation(BuiltInRegistries.ITEM.getKey(item), "item/"), () -> model);
    }

    @SafeVarargs
    private static void registerParented(
            BlockModelGenerators blockModelGenerators,
            Block parent,
            Block child,
            Tuple<TextureSlot, ResourceLocation>... textures
    )
    {
        ...
        ModelTemplate parentModel = new ModelTemplate(
                Optional.of(ModelLocationUtils.getModelLocation(parent)), Optional.empty(),
                textureKeys.toArray(new TextureSlot[0])
        );
    ...
    )
    {
        ...
        ModelTemplate parentModel = new ModelTemplate(
                Optional.of(parent), Optional.empty(), textureKeys.toArray(new TextureSlot[0]));

        parentModel.create(child, textureMap, blockModelGenerators.modelOutput);
    }

    private static ResourceLocation prefixResourceLocation(
    ...
    private static ResourceLocation suffixResourceLocation(
            ResourceLocation resourceLocation,
            String suffix
    )
    {
    ...
    private static JsonObject createModelTemplateJson(
    ...
    )
    {
        ...
        modelTemplate.model.ifPresent(
                resourceLocationFromLambda -> jsonObject.addProperty("parent", resourceLocationFromLambda.toString()));
        if (!map.isEmpty())
        {
            JsonObject jsonObject2 = new JsonObject();
            map.forEach((textureSlot, resourceLocationFromLambda) -> jsonObject2.addProperty(
                    textureSlot.getId(), resourceLocationFromLambda.toString()));
